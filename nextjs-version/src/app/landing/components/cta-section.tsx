...
import { ArrowRight, TrendingUp, MessageCircle, Phone } from 'lucide-react'
            ...
            <div className='space-y-8'>
              ...
              <div className='space-y-6'>
                ...
                <p className='text-muted-foreground mx-auto max-w-2xl text-balance lg:text-xl'>
                  Reach WBS instantly by WhatsApp, phone, email, or form submission and get professional assistance.
                </p>
              </div>
              ...
              <div className='flex flex-col justify-center gap-4 sm:flex-row sm:gap-6'>
                <Button size='lg' className='cursor-pointer px-8 py-6 text-lg font-medium' asChild>
                  <a href='https://wa.me/255658646358?text=Hello%2C%20I%20need%20assistance%20with%20WBS%20services.' target='_blank' rel='noopener noreferrer'>
              ...
              <div className='text-muted-foreground flex flex-wrap items-center justify-center gap-6 text-sm'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <span>Dashboard data management</span>
                </div>
              </div>
            </div>
          </div>
